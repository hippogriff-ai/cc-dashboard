...
// Source: Sources/KeyboardShortcuts/ConflictPolicy.swift
// Local modifications: none. (Type is referenced from the Recorder UI which
// is NOT vendored in this loop, but ConflictPolicy is small and pulled in to
// keep KeyboardShortcuts.swift's surface area unmodified.)
